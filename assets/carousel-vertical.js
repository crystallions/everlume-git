		...
		carouselVertical: function(argumentss){
			...
			var carouselVerticalClass = function(element, options){
				...
				function init(el, opts){
					...
					_this.addEventListener('touchstart', touchHandler, false);
					_this.addEventListener('MSPointerDown', touchHandler, false);
					_this.addEventListener('touchmove', touchHandler, false);
					_this.addEventListener('MSPointerMove', touchHandler, false);
					_this.addEventListener('touchend', touchHandler, false);
					_this.addEventListener('MSPointerUp', touchHandler, false);
					_this.addEventListener('touchcancel', touchHandler, false);
					...
					if(_options.nav){
						...
						prev_btn.addEventListener('touchend', touchHandler, false);
						prev_btn.addEventListener('MSPointerUp', touchHandler, false);
						prev_btn.addEventListener('click', prevClick, false);
						next_btn.addEventListener('touchend', touchHandler, false);
						next_btn.addEventListener('MSPointerUp', touchHandler, false);
